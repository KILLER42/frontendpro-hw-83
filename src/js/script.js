class Student {
  ...
  summary() {
    ...
    if (averageMark > 90 && averageAttendance > 0.9) return 'Excellent!';
    if (averageMark > 90 || averageAttendance > 0.9) return 'Good';
    if (averageMark < 90 && averageAttendance < 0.9) return 'Satisfactory!';
  }
}

const firstStudent = new Student('Alex', 'Smith', '1998-10-12', [], []);
const secondStudent = new Student('Joseph', 'Phillips', '1993-04-10', [], []);
const thirdStudent = new Student('Eugene', 'Frolov', '1995-08-07', [], []);
